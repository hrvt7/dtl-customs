          ...
          <FadeIn>
            <div>
              ...
              <h2 className="font-heading font-black text-3xl sm:text-5xl text-white text-balance mb-6">
                A DTL Customs mögött <span className="text-[#A3A3A3]">szenvedély</span> áll.
              </h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {benefits.map((b, i) => (
              <FadeIn key={b.title} delay={i * 100}>
                <div className="group relative h-full overflow-hidden bg-gradient-card border border-[#1F1F1F] rounded-2xl hover:border-[#A3A3A3]/40 hover-lift transition">
