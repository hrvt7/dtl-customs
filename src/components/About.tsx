          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {benefits.map((b, i) => (
              <FadeIn key={b.title} delay={i * 100}>
                <div className="h-full bg-gradient-card border border-[#262626] rounded-2xl p-6 hover:border-[#E10600]/40 transition">
                  <div className="w-12 h-12 rounded-xl bg-[#E10600]/10 border border-[#E10600]/20 flex items-center justify-center mb-4">
                    <b.icon className="w-6 h-6 text-[#E10600]" />
                  </div>
