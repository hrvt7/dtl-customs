      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <h2 className="font-heading font-black text-3xl sm:text-5xl text-white text-balance">
              Mikor <span className="text-[#A3A3A3]">fogadunk?</span>
            </h2>
        ...
        <FadeIn>
          <div className="bg-gradient-card border border-[#1F1F1F] rounded-3xl overflow-hidden">
                ...
                >
                  ...
                  <span
                    className={`font-medium ${
                      s.hours === "Zárva" ? "text-[#737373]" : s.note ? "text-[#A3A3A3]" : "text-[#D4D4D4]"
                    }`}
                  >
                    {s.hours}
                  </span>
            ...
            <div className="bg-[#A3A3A3]/5 border-t border-[#A3A3A3]/20 px-6 py-5 flex items-start gap-3">
              <CalendarCheck className="w-5 h-5 text-[#A3A3A3] flex-shrink-0 mt-0.5" />
              <p className="text-sm text-[#D4D4D4]">
                Minden fóliázás előzetes egyeztetést igényel. Hívj minket a{" "}
                <a href="tel:+36303899625" className="text-[#A3A3A3] font-semibold hover:underline">
                  +36 30 389 9625
                </a>{" "}
                számon, vagy írj a{" "}
                <a
                  href="mailto:dtlcustoms.info@gmail.com"
                  className="text-[#A3A3A3] font-semibold hover:underline"
                >
